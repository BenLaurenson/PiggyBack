...
const N_1 = "b0000000-0000-4000-a000-000000000001";
const USER_1 = "b0000000-0000-4000-a000-000000000010";
const EXP_1 = "b0000000-0000-4000-a000-000000000020";
const PARTNERSHIP_1 = "b0000000-0000-4000-a000-000000000030";
const OTHER_USER = "b0000000-0000-4000-a000-000000000099";
...
function createActionMockSupabase(
  ...
  memberChain.maybeSingle = vi.fn(() =>
    Promise.resolve({
      data: { partnership_id: PARTNERSHIP_1 },
      error: null,
    })
  );
...
describe("notifications/[id]/action route", () => {
  ...
  it("returns 401 for unauthenticated request", async () => {
    ...
    const res = await POST(req, { params: Promise.resolve({ id: N_1 }) });
  ...
  it("returns 404 for notification belonging to another user", async () => {
    ...
    const mock = createActionMockSupabase(notification, USER_1);
