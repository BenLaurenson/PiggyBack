...
export async function startOrResumeCheckup(financialYear?: number) {
  ...
  if (error) throw new Error(safeErrorMessage(error, "Failed to start checkup"));
  revalidatePath("/plan");
  return data;
}
...
export async function saveCheckupStep(
  ...
  if (fetchError) throw new Error(safeErrorMessage(fetchError, "Failed to fetch checkup data"));
  ...
  if (error) throw new Error(safeErrorMessage(error, "Failed to save checkup step"));
  revalidatePath("/plan");
}
...
export async function completeCheckup(
  ...
  if (error) throw new Error(safeErrorMessage(error, "Failed to complete checkup"));
  revalidatePath("/plan");
}
...
export async function resetCheckup(financialYear: number) {
  ...
  if (error) throw new Error(safeErrorMessage(error, "Failed to reset checkup"));
  revalidatePath("/plan");
}
