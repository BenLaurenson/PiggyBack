...
export async function createIncomeSource(data: IncomeSource) {
  ...
  try {
    ...
    console.error("Create income source exception:", error);
...
export async function getIncomeSources(userId: string) {
  ...
  try {
    ...
    console.error("Get income sources exception:", error);
    return { success: false, error: "Failed to fetch income sources", data: [] };
  }
}
...
export async function getManualPartnerIncomeSources(partnershipId: string) {
  try {
    ...
    if (error) {
      console.error("Get manual partner income sources error:", error);
      return { success: false, error: error.message, data: [] };
    }

    return { success: true, data: incomeSources || [] };
  } catch (error) {
    console.error("Get manual partner income sources exception:", error);
    return { success: false, error: "Failed to fetch manual partner income sources", data: [] };
  }
}
...
export async function updateIncomeSource(id: string, data: Partial<IncomeSource>) {
  ...
  try {
    ...
    console.error("Update income source exception:", error);
...
export async function deleteIncomeSource(id: string) {
  ...
  try {
    ...
    console.error("Delete income source exception:", error);
...
export async function markOneOffReceived(id: string) {
  ...
  try {
    ...
    console.error("Mark received exception:", error);
