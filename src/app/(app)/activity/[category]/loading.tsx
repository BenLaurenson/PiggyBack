...
export default function CategoryActivityLoading() {
  return (
    <div
    ...
    >
      ...
      {/* Hero Section - icon + category name + subtitle */}
      <div className="space-y-1">
        <div className="flex items-center gap-2 sm:gap-3">
          <Skeleton className="h-9 w-9 sm:h-10 sm:w-10 rounded flex-shrink-0" />
          <Skeleton className="h-8 sm:h-9 md:h-10 w-40" />
        </div>
        <Skeleton className="h-4 sm:h-5 w-44" />
      </div>
