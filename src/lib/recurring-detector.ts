...
export function detectRecurringTransactions(
  ...
  // Pre-compute normalized → original description mapping (first occurrence wins)
  ...
  transactions.forEach(txn => {
    ...
    if (!groups.has(normalized)) {
      ...
      originalDescriptions.set(normalized, txn.description);
    }
  ...
  groups.forEach((txns, description) => {
    ...
    recurring.push({
      description: originalDescriptions.get(description) || description,
