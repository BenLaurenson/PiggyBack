...
function getCategoryName(
  ...
  return mapping?.new_parent_name || "Uncategorized";
}
...
export function generateInsights(
  ...
  insights.push(...detectSpendingAnomalies(spending, categoryMappings));
  ...
  insights.push(...detectCategoryTrends(spending, categoryMappings));
