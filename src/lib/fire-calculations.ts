 ...
 *
 * Outside-super grows by: annual savings + investment returns
...
function runProjection(
  ...
  for (let age = currentAge; age <= maxAge; age++) {
    ...
    // Calculate this year's savings and super contribution
    ...
    outsideSuper = Math.round(outsideSuper * (1 + outsideReturnRate) + Math.max(0, annualSavings));
